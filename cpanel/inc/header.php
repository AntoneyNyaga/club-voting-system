...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/css/bootstrap-toggle.min.css">
    <link rel="stylesheet" href="../assets/css/css/bootstrap-toggle.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="add_org.php"><span class="glyphicon glyphicon-plus-sign"></span>Add Club</a></li>
                ...
                <li><a href="vote_result.php"><span class="glyphicon glyphicon-plus-sign"></span>Vote Results</a></li>
                <li class="dropdown">
